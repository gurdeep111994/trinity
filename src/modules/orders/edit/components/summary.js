				...
				<div className={style.innerBox}>
					...
					<div className={`${style.summaryRow} row`}>
						<div className="col-xs-5">
							<span className={style.txtLabel}>{messages.orderDate}</span>
						</div>
					...
					<div className={`${style.summaryRow} row`}>
						<div className="col-xs-5">
							<span className={style.txtLabel}>{messages.orderStatus}</span>
						</div>
					...
					<div className={`${style.summaryRow} row`}>
						<div className="col-xs-5">
							<span className={style.txtLabel}>{messages.referrer}</span>
						</div>
					...
					<div className={`${style.summaryRow} row`}>
						<div className="col-xs-5">
							<span className={style.txtLabel}>{messages.trackingNumber}</span>
						</div>
					...
					<div className={`${style.summaryRow} row`}>
						<div className="col-xs-5">
							<span className={style.txtLabel}>{messages.shippingStatus}</span>
						</div>
					...
					<div className={`${style.summaryRow} row`}>
						<div className="col-xs-5">
							<span className={style.txtLabel}>{messages.shippingMethod}</span>
						</div>
					...
					<div className={`${style.summaryRow} row`}>
						<div className="col-xs-5">
							<span className={style.txtLabel}>{messages.paymentsMethod}</span>
						</div>
					...
					<div className={`${style.summaryRow} row`}>
						<div className="col-xs-5">
							<span className={style.txtLabel}>{messages.customerComment}</span>
						</div>
