		...
		<div>
			<div className={`${style.total} row`}>
				<div className="col-xs-7">
					<span className={style.txtLabel}>{messages.orderSubtotal}</span>
				</div>
				<div className="col-xs-5">{subtotal}</div>
			</div>
			<div className={`${style.total} row`}>
				<div className="col-xs-7">
					<span className={style.txtLabel}>{messages.orderShipping}</span>
				</div>
				<div className="col-xs-5">{shippingTotal}</div>
			</div>
			<div className={`${style.total} row`}>
				<div className="col-xs-7">
					<span className={style.txtLabel}>{messages.orderTax}</span>
				</div>
			...
			<Divider className={style.halfDivider} />
			...
			<div className={`${style.total} row`}>
				<div className="col-xs-7">
					<span className={style.txtLabel}>{messages.amountPaid}</span>
				</div>
